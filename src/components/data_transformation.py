...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            save_object(self.data_transformation_config.data_transformation_transformed_object_filepath, preprocessor)
            save_numpy_array_data(self.data_transformation_config.data_transformation_transformed_train_filepath,train_arr)
            save_numpy_array_data(self.data_transformation_config.data_transformation_transformed_test_filepath, test_arr)
            
            logger.info("Data transformation completed successfully")
            
            return DataTransformationArtifact(
                transformed_object_file_path=self.data_transformation_config.data_transformation_transformed_object_filepath,
                transformed_train_file_path=self.data_transformation_config.data_transformation_transformed_train_filepath,
                transformed_test_file_path=self.data_transformation_config.data_transformation_transformed_test_filepath
            )
